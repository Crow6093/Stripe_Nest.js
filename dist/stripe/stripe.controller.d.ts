...
export declare class StripeController {
    ...
    createCheckoutSession(req: Request, res: Response): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Checkout.Session>>;
    successPayment(createStripeDto: CreateStripeDto): string;
    failedPayment(createStripeDto: CreateStripeDto): string;
}
